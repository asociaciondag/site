...
!function (e) {
  ...
  !function (e) {
    if (!e.browser) {
      var t = e.browser = {},
        ...
        i = /(chrome)[ \/]([\w.]+)/.exec(n) ||
          /(safari)[ \/]([\w.]+)/.exec(n) || /(webkit)[ \/]([\w.]+)/.exec(n) ||
  ...
  window.flowplayer = function (t) {
    ...
    e.extend(flowplayer, {
      ...
      defaults: {
        ...
        speeds: [.25, .5, 1, 1.5, 2],
        tooltip: !0,
        volume: "object" != typeof localStorage
          ? 1
  ...
  e.fn.flowplayer = function (t, n) {
    return "string" == typeof t && (t = { swf: t }),
      e.isFunction(t) && (n = t, t = {}),
      !t && this.data("flowplayer") || this.each(function () {
        var i,
          a,
          r = e(this).addClass("is-loading"),
          o = e.extend({}, flowplayer.defaults, flowplayer.conf, t, r.data()),
        ...
        if (o.playlist.length) {
          ...
          l.length && l.replaceWith(v = e("<p />")),
            ...
            v ? v.replaceWith(l) : r.prepend(l),
            l.attr("preload", g),
            "string" == typeof o.playlist[0]
              ? l.attr("src", o.playlist[0])
              : e.each(o.playlist[0], function (t, n) {
                for (var i in n) {
                  n.hasOwnProperty(i) &&
                    l.append(
                      e("<source />").attr({ type: "video/" + i, src: n[i] }),
                    );
                }
              }),
            d = new s(l);
        }
        var m = r.data("flowplayer");
        m && m.unload(), r.data("fp-player_id", r.data("fp-player_id") || p++);
        try {
          f = window.localStorage || f;
        } catch (h) {}
        var y = this.currentStyle && "rtl" === this.currentStyle.direction ||
        ...
        var b = m ||
          {
            conf: o,
            currentSpeed: 1,
            volumeLevel: "undefined" == typeof o.volume
              ? 1 * f.volume
              : o.volume,
            video: {},
            disabled: !1,
            ...
            pause: function (e) {
              return !b.ready || b.seeking || b.disabled || b.loading ||
                (a.pause(), b.one("pause", e)),
                b;
            },
            resume: function () {
              return b.ready && b.paused && !b.disabled &&
                (a.resume(),
            ...
            seek: function (t, n) {
              if (b.ready) {
                if ("boolean" == typeof t) {
                  var o = .1 * b.video.duration;
                  t = b.video.time + (t ? o : -o);
                }
                t = i = Math.min(Math.max(t, 0), b.video.duration).toFixed(1);
                var s = e.Event("beforeseek");
                r.trigger(s, [b, t]),
                  s.isDefaultPrevented()
                    ? (b.seeking = !1, r.toggleClass("is-seeking", b.seeking))
                    : (a.seek(t), e.isFunction(n) && r.one("seek", n));
              }
              return b;
            },
            seekTo: function (e, t) {
            ...
            mute: function (e) {
              return void 0 === e && (e = !b.muted),
                f.muted = b.muted = e,
                f.volume = isNaN(f.volume) ? o.volume : f.volume,
                b.volume(e ? 0 : f.volume, !0),
                b.trigger("mute", e),
                b;
            },
            volume: function (e, t) {
            ...
            speed: function (t, n) {
              return b.ready &&
                ("boolean" == typeof t &&
                  (t = o.speeds[
                    e.inArray(b.currentSpeed, o.speeds) + (t ? 1 : -1)
                  ] || b.currentSpeed),
                  a.speed(t),
                  n && r.one("speed", n)),
                b;
            ...
            unload: function () {
              return r.hasClass("is-embedding") ||
                (o.splash ? (b.trigger("unload"), a.unload()) : b.stop()),
                b;
            },
            disable: function (e) {
        ...
        b.conf = e.extend(b.conf, o),
          ...
          r.data("flowplayer") || r.bind("boot", function () {
            return e.each(
              ...
              (o.splash || r.hasClass("is-splash") ||
                !flowplayer.support.firstframe) &&
              (b.forcedSplash = !o.splash && !r.hasClass("is-splash"),
                b.splash = o.splash = o.autoplay = !0,
                r.addClass("is-splash"),
                l.attr("preload", "none")),
              e.each(c, function () {
                this(b, r);
              }),
              a = flowplayer.engine[o.engine],
              a && (a = a(b, r)),
              ...
              u.push(b),
              b.engine
                ? (o.splash ? b.unload() : b.load(),
                  o.disabled && b.disable(),
            ...
            o.splash &&
            e(".flowplayer").filter(".is-ready, .is-loading").not(r).each(
              function () {
            ...
            function i() {
              r.removeClass("is-loading"), t.loading = !1;
            }
            n.time = 0,
              t.video = n,
              o.splash ? r.one("progress", i) : i(),
              t.muted ? t.mute(!0) : t.volume(t.volumeLevel);
          }).bind("unload", function () {
            o.splash && l.remove(), r.removeClass("is-loading"), b.loading = !1;
          }).bind("ready unload", function (e) {
            var t = "ready" == e.type;
            r.toggleClass("is-splash", !t).toggleClass("is-ready", t),
              b.ready = t,
              b.splash = !t;
            ...
            t.volumeLevel = Math.round(100 * n) / 100,
              t.muted ? n && t.mute(!1) : f.volume = n;
          }).bind("beforeseek seek", function (e) {
            b.seeking = "beforeseek" == e.type,
              r.toggleClass("is-seeking", b.seeking);
          }).bind("ready pause resume unload finish stop", function (e, t, n) {
            b.paused = /pause|finish|unload|stop/.test(e.type),
              "ready" == e.type &&
              (b.paused = "none" == o.preload,
                n &&
                (b.paused = !n.duration || !o.autoplay && "none" != o.preload)),
              b.playing = !b.paused,
              r.toggleClass("is-paused", b.paused).toggleClass(
                "is-playing",
                b.playing,
              ),
              b.load.ed || b.pause();
          ...
          r.trigger("boot", [b, r]).data("flowplayer", b);
      });
  },
    !function () {
      var t = function (e) {
        ...
        s = /iPad|MeeGo/.test(o) && !/CriOS/.test(o),
        l = /iPad/.test(o) && /CriOS/.test(o),
        d = /iP(hone|od)/i.test(o) && !/iPad/.test(o),
        u = /Android/.test(o) && !/Firefox/.test(o),
        c = /Android/.test(o) && /Firefox/.test(o),
        f = /Silk/.test(o),
        p = /IEMobile/.test(o),
        v =
          (s ? t(o) : 0,
            u ? parseFloat(/Android\ (\d\.\d)/.exec(o)[1], 10) : 0);
      e.extend(n, {
        subtitles: !!a.addTextTrack,
        fullscreen: !u &&
          ("function" == typeof document.webkitCancelFullScreen &&
              !/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(o) ||
            document.mozFullScreenEnabled ||
            "function" == typeof document.exitFullscreen),
        inlineBlock: !(r && i.version < 8),
        touch: "ontouchstart" in window,
        dataload: !s && !d && !p,
        zeropreload: !r && !u,
        volume: !(s || u || d || f || l),
        cachedVideoTag: !(s || d || l || p),
        firstframe: !(d || s || u || f || l || p || c),
        inlineVideo: !d && !f && !p && (!u || v >= 3),
    ...
    flowplayer.engine.flash = function (n, i) {
      ...
      var l = {
        ...
        load: function (l) {
          function d(e) {
            return e.replace(/&amp;/g, "%26").replace(/&/g, "%26").replace(
              /=/g,
              "%3D",
            );
          }
          ...
          if (
            ...
            i.data("origin") && (f.origin = i.data("origin")),
      ...
      e.each("pause,resume,seek,volume".split(","), function (e, t) {
        l[t] = function (e) {
          n.ready &&
            ("seek" == t && n.video.time && !n.paused &&
              n.trigger("beforeseek"),
              void 0 === e ? o["__" + t]() : o["__" + t](e));
        };
      });
      var d = e(window);
      return n.bind("ready fullscreen fullscreen-exit", function (t) {
        ...
        if (n.conf.flashfit || /full/.test(t.type)) {
          var o,
            ...
            f = l ? u ? screen.availWidth : d.width() : r,
            p = l ? u ? screen.availHeight : d.height() : a,
            v = u ? screen.width - screen.availWidth : 0,
            g = u ? screen.height - screen.availHeight : 0,
            m = c ? r : "",
            h = c ? a : "";
          (n.conf.flashfit || "fullscreen" === t.type) &&
          (o = n.video.width / n.video.height,
            s = n.video.height / n.video.width,
            h = Math.max(s * f),
            m = Math.max(o * p),
            h = h > p ? m * s : h,
            h = Math.min(Math.round(h), p),
            m = m > f ? h * o : m,
            m = Math.min(Math.round(m), f),
            g = Math.max(Math.round((p + g - h) / 2), 0),
            v = Math.max(Math.round((f + v - m) / 2), 0)),
            e("object", i).css({
              width: m,
              height: h,
              marginTop: g,
  ...
  var v,
    ...
    h = function (t) {
      return v ? v.attr({ type: i(t.type), src: t.src }) : v = e("<video/>", {
        src: t.src,
        type: i(t.type),
        "class": "fp-engine",
        autoplay: "autoplay",
  ...
  flowplayer.engine.html5 = function (t, i) {
    function o(r, o, s) {
      r.listeners && r.listeners.hasOwnProperty(i.data("fp-player_id")) ||
        ((r.listeners || (r.listeners = {}))[i.data("fp-player_id")] = !0,
          o.bind("error", function (n) {
            try {
              if (
                n.originalEvent && e(n.originalEvent.originalTarget).is("img")
              ) return n.preventDefault();
              a(e(n.target).attr("type")) && t.trigger("error", { code: 4 });
            } catch (i) {}
          }),
          e.each(m, function (a, o) {
            r.addEventListener(a, function (d) {
              if (
                "progress" == o && d.srcElement &&
                0 === d.srcElement.readyState && setTimeout(function () {
                  t.video.duration || (o = "error", t.trigger(o, { code: 4 }));
                }, 1e4),
                  p.debug && !/progress/.test(o) && console.log(a, "->", o, d),
                  (t.ready || /ready|error/.test(o)) && o &&
                  e("video", i).length
              ) {
                var u, f = e.Event(o);
                switch (o) {
                  case "ready":
                    ...
                    try {
                      u.seekable = r.seekable && r.seekable.end(null);
                    } catch (v) {}
                    if (
                      l = l || setInterval(function () {
                        try {
                          u.buffer = r.buffered.end(null);
                        } catch (e) {}
                        u.buffer && (u.buffer <= u.duration && !u.buffered
                          ? t.trigger("buffer", d)
                          : u.buffered ||
                            (u.buffered = !0,
                        ...
                        !u.duration && !c.hlsDuration && "loadeddata" === a
                    ) {
                      var g = function () {
                        ...
                        t.trigger(f, u),
                          r.removeEventListener("durationchange", g);
                      };
    ...
    return s = {
      pick: function (e) {
        if (c.video) {
          if (p.videoTypePreference) {
            var t = r(e, p.videoTypePreference);
            if (t) return t;
          }
      ...
      load: function (n) {
        if (p.splash && !d) {
          u = h(n).prependTo(i),
            c.inlineVideo || u.css({ position: "absolute", top: "-9999em" }),
            f.length && u.append(f.attr("default", "")),
            p.loop && u.attr("loop", "loop"),
            d = u[0];
        } else {
          d = u[0];
          var a = u.find("source");
          !d.src && a.length && (d.src = n.src, a.remove()),
            t.video.src && n.src != t.video.src
              ...
              : "none" != p.preload && c.dataload ||
                (c.zeropreload
                  ? t.trigger("ready", n).trigger("pause").one(
                    "ready",
                    function () {
                      i.trigger("resume");
                    },
        ...
        o(d, e("source", u).add(u), n),
          "none" == p.preload && c.zeropreload && c.dataload || d.load(),
          p.splash && d.load();
      },
      pause: function () {
        d.pause();
  ...
  e.throttle = function (e, t) {
    ...
    e.fn.slider2 = function (t) {
      var n = /iPad/.test(navigator.userAgent) &&
      ...
      return this.each(function () {
        var i,
          ...
          h = function (e) {
            var n = e.pageX;
            !n && e.originalEvent && e.originalEvent.touches &&
              e.originalEvent.touches.length &&
              (n = e.originalEvent.touches[0].pageX);
            var i = s ? e.pageY - a.top : n - a.left;
            i = Math.max(0, Math.min(u || l, i));
            var r = i / l;
            return s && (r = 1 - r), t && (r = 1 - r), y(r, 0, !0);
          },
          y = function (e, t) {
            void 0 === t && (t = 0), e > 1 && (e = 1);
            var i = Math.round(1e3 * e) / 10 + "%";
            return (!d || d >= e) && (n || p.stop(),
              v
                ? p.css("width", i)
                : p.animate(s ? { height: i } : { width: i }, t, "linear")),
              e;
          },
          b = function (e) {
            return Math.max(0, Math.min(l, s ? (1 - e) * o : e * r));
          },
          w = {
            max: function (e) {
              d = e;
          ...
          c.data("api", w).bind("mousedown.sld touchstart", function (t) {
            if (t.preventDefault(), !i) {
              ...
              g(),
                ...
                m(h(t)),
                f.bind("mousemove.sld touchmove", function (e) {
                  e.preventDefault(), n(h(e));
                }).one("mouseup touchend", function () {
                  w.dragging = !1,
                    c.removeClass("is-dragging"),
                    f.unbind("mousemove.sld touchmove");
                });
            }
          });
      });
    ...
    flowplayer(function (t, n) {
      ...
      function a(t) {
        ("0px" === n.css("width") || "0px" === n.css("height") ||
          t !== flowplayer.defaults.ratio) &&
        (parseInt(y, 10) || g.css("paddingTop", 100 * t + "%")),
          l.inlineBlock || e("object", n).height(n.height());
      }
      function r(e) {
        n.toggleClass("is-mouseover", e).toggleClass("is-mouseout", !e);
      }
      var o, s = t.conf, l = flowplayer.support;
      n.find(".fp-ratio,.fp-ui").remove(),
        n.addClass("flowplayer").append(
          '      <div class="ratio"/>      <div class="ui">         <div class="waiting"><em/><em/><em/></div>         <a class="fullscreen"/>         <a class="unload"/>         <p class="speed"/>         <div class="controls">            <a class="play"></a>            <div class="timeline">               <div class="buffer"/>               <div class="progress"/>            </div>            <div class="volume">               <a class="mute"></a>               <div class="volumeslider">                  <div class="volumelevel"/>               </div>            </div>         </div>         <div class="time">            <em class="elapsed">00:00</em>            <em class="remaining"/>            <em class="duration">00:00</em>         </div>         <div class="message"><h2/><p/></div>      </div>'
      ...
      t.bind("ready", function () {
        ...
        !e.seekable && l.seekable && w.max(n),
          1 > n ? c.css("width", 100 * n + "%") : c.css({ width: "100%" });
      }).bind("speed", function (e, t, n) {
        ...
        if (n.removeClass("is-loading").addClass("is-error"), a) {
          ...
          e("h2", r).text((i.engine || "html5") + ": " + a.message),
            e("p", r).text(
            ...
            i
              ? (n.bind("pause.x mousemove.x volume.x", function () {
                ...
                o = setInterval(function () {
                  new Date() - t > 5e3 && (r(!1), t = new Date());
                }, 100))
              : (n.unbind(".x"), clearInterval(o));
        }
      ...
      !_ || s.splash || s.autoplay || t.bind("ready stop", function () {
        ...
        !_ && t.forcedSplash && n.css("backgroundColor", "#555"),
  ...
  e(document).bind("keydown.fp", function (t) {
    ...
    flowplayer(function (t, n) {
      t.conf.keyboard && (n.bind("mouseenter mouseleave", function (e) {
        ...
        t.conf.tooltip &&
        e(".fp-ui", n).attr("title", "Hit ? for help").on(
          "mouseout.tip",
          function () {
  ...
  var x,
    ...
    _ = "function" == typeof document.exitFullscreen,
    E = navigator.userAgent.toLowerCase(),
    M = /(safari)[ \/]([\w.]+)/.exec(E) && !/(chrome)[ \/]([\w.]+)/.exec(E);
  e(document).bind(
    _ ? "fullscreenchange" : C + "fullscreenchange",
    function (t) {
      var n = e(
    ...
    flowplayer(function (t, n) {
      if (t.conf.fullscreen) {
        var i, a = e(window), r = { pos: 0, play: !1 };
        t.isFullscreen = !1,
          t.fullscreen = function (e) {
            return t.disabled
              ? void 0
              : (void 0 === e && (e = !t.isFullscreen),
                e && (i = a.scrollTop()),
                F
                  ? e
                    ? _
                      ...
                      : (n[0][C + "RequestFullScreen"](
                        ...
                        !M || document.webkitCurrentFullScreenElement ||
                        document.mozFullScreenElement ||
                        n[0][C + "RequestFullScreen"]())
                    : _
                    ? document.exitFullscreen()
                    : document[C + "CancelFullScreen"]()
                  : ("flash" === t.engine && t.conf.rtmp &&
                    (r = { pos: t.video.time, play: t.playing }),
                    t.trigger(e ? T : S, [t])),
                t);
          };
        var o;
    ...
    flowplayer(function (t, n) {
      ...
      t.play = function (n) {
        ...
        r.advance && n.unbind("finish.pl").bind("finish.pl", function (e, t) {
          var i = t.video.index + 1;
          i < t.conf.playlist.length || r.loop
      ...
      if (t.conf.playlist.length) {
        ...
        if (!l.length) {
          ...
          var d = e(".fp-next,.fp-prev", n).eq(0).before(l);
          d.length || e("video", n).after(l);
        }
        l.empty(),
          e.each(t.conf.playlist, function (t, n) {
            var i;
            if ("string" == typeof n) i = n;
            else {for (var a in n[0]) {
      ...
      if (i().length) {
        s || (t.conf.playlist = [],
          ...
          n.on("click", r.query, function (n) {
            n.preventDefault();
            var i = e(n.target).closest(r.query),
              a = Number(i.attr("data-index"));
            -1 != a && t.play(a);
          });
        var u = i().filter("[data-cuepoints]").length;
        t.bind("load", function (i, r, s) {
          var l = a().removeClass(o),
            d = l.attr("data-index"),
            c = s.index = t.video.index || 0,
            f = e('a[data-index="' + c + '"]', n).addClass(o),
            p = c == t.conf.playlist.length - 1;
          n.removeClass("video" + d).addClass("video" + c).toggleClass(
            "last-video",
            p,
          ),
            s.index = r.video.index = c,
            s.is_last = r.video.is_last = p,
            u && (t.cuepoints = f.data("cuepoints"));
  ...
  flowplayer(function (t, n) {
    ...
    t.cuepoints = t.conf.cuepoints || [],
      t.bind("progress", function (e, r, o) {
        if (a && .015 > o - a) return a = o;
        a = o;
        for (var s, l = t.cuepoints || [], d = 0; d < l.length; d++) {
          s = l[d],
            ...
            s.index = d,
            Math.abs(s.time - o) < .125 * t.currentSpeed &&
      ...
      t.conf.generate_cuepoints && t.bind("load", function () {
        ...
        var i = t.cuepoints || [],
          a = t.video.duration,
          r = e(".fp-timeline", n).css("overflow", "visible");
        e.each(i, function (n, i) {
          var o = i.time || i;
          0 > o && (o = a + i);
          var s = e("<a/>").addClass("fp-cuepoint fp-cuepoint" + n).css(
            "left",
            100 * (o / a) + "%",
          );
      ...
      if (
        ...
        if (s) {
            ...
            for (
              ...
              if (r = o.exec(u[d])) {
                ...
                f = {
                  ...
                  l = { time: f.startTime, subtitle: f },
                  t.subtitles.push(f),
                  t.cuepoints.push(l),
                  t.cuepoints.push({ time: f.endTime, subtitleEnd: a }),
                  0 === f.startTime && t.trigger("cuepoint", l);
              }
            }
          }).fail(function () {
          ...
          t.bind("cuepoint", function (e, t, n) {
            ...
            l && t.cuepoints[l] && t.cuepoints[l].time > a &&
            (d.removeClass("fp-active"), l = null),
              e.each(t.cuepoints || [], function (e, n) {
                var i = n.subtitle;
                i && l != n.index
                  ? a >= n.time && (!i.endTime || a <= i.endTime) &&
                    t.trigger("cuepoint", n)
                  : n.subtitleEnd && a >= n.time && n.index == l + 1 &&
                    t.trigger("cuepoint", n);
              });
          });
        }
    ...
    flowplayer(function (t, n) {
      ...
      var a = t.conf.analytics, r = 0, o = 0;
      a &&
        ("undefined" == typeof _gat &&
          e.getScript("//google-analytics.com/ga.js"),
          t.bind("load unload", i).bind("progress", function () {
            t.seeking || (r += o ? +new Date() - o : 0, o = +new Date());
          }).bind("pause", function () {
            o = 0;
          }),
          e(window).unload(i));
    });
  var A = /IEMobile/.test(f);
  (flowplayer.support.touch || A) && flowplayer(function (t, n) {
    var i = /Android/.test(f) && !/Firefox/.test(f) && !/Opera/.test(f),
      a = /Silk/.test(f);
    if (i) {
    ...
    n.bind("touchmove", function () {
      ...
      return o
        ...
        : (t.paused && n.hasClass("is-mouseout") && t.toggle(),
          t.paused && A && e("video", n)[0].play(),
          void 0);
    }),
      t.conf.native_fullscreen && (e.browser.webkit || e.browser.safari) &&
    ...
    flowplayer(function (t, n) {
      if (t.conf.embed !== !1) {
        var i = t.conf,
          a = e(".fp-ui", n),
          r = e("<a/>", { "class": "fp-embed", title: "Copy to your site" })
            .appendTo(a),
          o = e("<div/>", { "class": "fp-embed-code" }).append(
        ...
        t.embedCode = function () {
          ...
          e.each(
            ["origin", "analytics", "logo", "key", "rtmp"],
            function (e, t) {
          ...
          var d = { src: "//embed.flowplayer.org/5.4.3/embed.min.js" };
    ...
    e.fn.fptip = function (t, n) {
      return this.each(function () {
        ...
        e(t || "a", this).click(function (t) {
          t.preventDefault(),
            a.toggleClass(n),
            a.hasClass(n) && e(document).bind("keydown.st", function (e) {
              27 == e.which && i();
